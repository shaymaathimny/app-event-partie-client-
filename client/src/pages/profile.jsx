import { Avatar, Typography, Button,Dialog,
  DialogHeader,
  DialogBody,
  DialogFooter,
            ...
            <div className="px-6">
              <div className="flex flex-wrap justify-center">
                ...
                <div className="mt-10 flex w-full justify-center px-4 lg:order-3 lg:mt-0 lg:w-4/12 lg:justify-end lg:self-center">
                  ...
                  <Button onClick={handleOpen} variant="gradient" className="bg-blue-400">Edit Profile</Button>
                  <Button onClick={()=>{}} className="ml-5 mr-5" color="red">Delete Account</Button>
                  
                  </div>
                  <div className="mt-10 flex w-full justify-center px-4 lg:order-3 lg:mt-0 lg:w-4/12 lg:justify-end lg:self-center">
                  <Button onClick={logoutHandler} className="ml-5 mr-5 bg-red-400 hover:bg-red-200 ">logout</Button>
                  </div>
